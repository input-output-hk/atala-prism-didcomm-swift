...
public class ExampleSecretsResolver: ExampleSecretsResolverProtocol {
    ...
    public func getSecret(secretid secretId: String, cb: OnGetSecretResult )  -> ErrorCode {
        let _retval = try!
    rustCall() {
    ...
    public func findSecrets(secretids secretIds: [String], cb: OnFindSecretsResult )  -> ErrorCode {
        let _retval = try!
    rustCall() {
